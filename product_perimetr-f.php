...
<div class="col-xs-10 b-content b-product-page _dark-yellow" data-equalheight>
	...
	<div class="b-intro _mb-m">
		<img class="b-intro__logo" src="img/logo/product-page/perimetr-f.png" alt="Периметр-Ф">
