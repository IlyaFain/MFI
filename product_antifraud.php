...
<div class="col-xs-12 b-content b-product-page _green">
	...
	<div class="b-intro _mb-m">
		<img class="b-intro__logo" src="img/logo/product-page/antifraud.png" alt="Антифрод">
	...
	<div class="b-submenu _mb-xxl">
		<nav>
			<ul>
				...
				<li class="b-submenu__item"><a class="_fill" data-modal-show="#modal_consult" href="#">Получить консультацию</a></li>
			</ul>
		</nav>
	</div>
