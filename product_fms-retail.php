<?
define('PAGE_TITLE', 'Продукты - FMS Retail');
...
<div class="col-xs-10 b-content b-product-page _dark-violet" data-equalheight>
	...
	<div class="b-intro _mb-m">
		<img class="b-intro__logo" src="img/logo/product-page/fms-retail.png" alt="FMS Retail">
