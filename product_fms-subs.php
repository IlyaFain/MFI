<?
define('PAGE_TITLE', 'Продукты - FMS Subs');
?>
...
<div class="col-xs-10 b-content b-product-page _cyan" data-equalheight>
	...
	<div class="b-intro _mb-m">
		<img class="b-intro__logo" src="img/logo/product-page/fms-subs.png" alt="FMS Subs">
