<?
define('PAGE_TITLE', 'Направление - СОРМ');
?>
...
<div class="col-xs-10 b-content  b-direction-page _blue" data-equalheight>
	...
	<div class="b-intro _border-bottom">
		<img class="b-intro__logo" src="img/logo/directions/sorm.png" alt="МФИ-Софт">
	...
	<div class="b-products _mb-l">
		<h2>Наши продукты</h2>
		<? require_once("templates/direction_sorm_intro.php") ?>
	</div>
