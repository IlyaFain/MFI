		...
		<div class="col-xs-12">
			<div class="b-product-intro _mb-xl">
				<div class="b-product-intro__text">
					...
					<p>Фильтрация трафика, предупреждение,обнаружение и подавление DDoS-атак </p>
					<ul class="b-products__sub">
						<li class="">
							<div class="b-product-intro__text">
								<h3><a class="b-product-intro__link" href="#">СОРМович-VoIP</a></h3>
								<p>Пассивный съем для сетей IP-телефонии</p>
							</div>
						</li>
						<li class="">
							<div class="b-product-intro__text">
								<h3><a class="b-product-intro__link" href="#">СОРМович-E1T</a></h3>
								<p>Осуществляет пассивный съем с Е1-каналов</p>
							</div>
						</li>
						<li class="">
							<div class="b-product-intro__text">
								<h3><a class="b-product-intro__link" href="#">ТРОПА</a></h3>
								<p>Передача данных между несколькими АТС и ПУ</p>
							</div>
						</li>
						<li class="">
							<div class="b-product-intro__text">
								<h3><a class="b-product-intro__link" href="#">ТРОПА 3G</a></h3>
								<p>Обеспечивает работу услуги «Видеовызов»</p>
							</div>
						</li>
						<li class="">
							<div class="b-product-intro__text">
								<h3><a class="b-product-intro__link" href="#">Конвертеры LI-СОРМ</a></h3>
								<p>Для основных видов телефонных&nbsp;коммутаторов</p>
							</div>
						</li>
					</ul>
				</div>
