<?
define('PAGE_TITLE', 'Продукты - FMS Payments');
...
<div class="col-xs-10 b-content b-product-page _dark-green" data-equalheight>
	...
	<div class="b-intro _mb-m">
		<img class="b-intro__logo" src="img/logo/product-page/fms-payments.png" alt="FMS Payments">
